...
//bool dwm_receive(DWM_Module* module, uint8_t* buffer, uint16_t max_len)
//{
//    uint8_t status[5] = {0};
//    uint8_t finfo[4] = {0};
//
...
//    for (int i = 0; i < tries; i++)
//    {
//        dwm_read_reg(module, 0x0F, status, 5);
//
//        // Good frame = RXFCG (bit 14 => byte1 bit6)
//        if (status[1] & 0x40)
//        {
//            dwm_read_reg(module, 0x10, finfo, 4);
//            uint16_t tflen = finfo[0] & 0x7F;   // includes CRC
//
//            if (tflen < 2) {
//                goto rx_error;
//            }
//
//            uint16_t payload_len = tflen - 2;
//            if (payload_len > max_len) {
//                goto rx_error;
//            }
//
//            dwm_read_reg(module, 0x11, buffer, payload_len);
//
//            // Clear good RX bits
//            uint8_t clear[5] = {0};
//            clear[1] = 0x6C; // RXFCG | RXDFR | RXPHD? | LDEDONE as needed
//            dwm_write_reg(module, 0x0F, clear, 5);
//
//            return true;
//        }
//
//        // Any RX error / reject path
//        if (status[1] & 0x90) // example: RXFCE / RXPHE
//        {
//            goto rx_error;
//        }
//
//        // If you know where RXPREJ lands in your decode, check it too
//    }
//
//rx_error:
//    {
...
//        dwm_write_reg(module, 0x0D, sys_ctrl, 4);
//
//        // Clear only the RX-related bits you care about
//        uint8_t clear[5] = {0};
//        // fill with proper masks for RX errors/rejects in your implementation
//        dwm_write_reg(module, 0x0F, clear, 5);
//
//        return false;
//    }
...
//        dwm_read_reg(module, 0x0F, status, 5);
//
//        bool rxdfr   = status[1] & 0x20;
//        bool rxfcg   = status[1] & 0x40;
//        bool ldedone = status[1] & 0x04;
//
...
//
//            if (payload_len > max_len) {
//                // clear status and fail safely
//                uint8_t clear[5] = {0};
//                clear[1] = 0x20 | 0x40 | 0x04 | 0x80 | 0xF0;
//                dwm_write_reg(module, 0x0F, clear, 5);
//                return false;
//            }
//
...
//
//            uint8_t clear[5] = {0};
//            clear[1] = 0x20 | 0x40 | 0x04;
//            dwm_write_reg(module, 0x0F, clear, 5);
//
//            return true;
//        }
//
//        // optional: reject RX errors immediately
//        if (status[1] & 0x80) { // RXFCE
//            break;
//        }
//    }
//
